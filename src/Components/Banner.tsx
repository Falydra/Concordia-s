...
<motion.h1
  className="bg-gradient-to-r sm:text-xl text-5xl from-red-500 to-blue-500 bg-clip-text text-transparent md:text-8xl font-semibold relative z-4 md:mb-0 mb-12"
  style={{
    y: textY,
    textShadow: `
